...
import { showChats, showCreateBlogs, showConnections, showSavePosts, showProfile } from '../../store/actions/index';
...
const FeaturesHeader = () => {
	...
	return (
		<div className="header">
			...
			<Avatar src={ bookmark } bg noRad extraStyle="u-c-pointer" alt="Bookmark" size='3rem' handleClick={ () => dispatch(showSavePosts()) } />
